...
class AdminController extends EcjiaAdminController
{
    public function __construct()
    {
        parent::__construct();

        ecjia_screen::get_current_screen()->add_nav_here(new admin_nav_here(__('API管理', 'api'), RC_Uri::url('api/admin/init')));
    }

    public function init()
    {
        $this->admin_priv('api_manage', ecjia::MSGTYPE_JSON);
        ...
        return $this->display('api_list.dwt');
    }
}
